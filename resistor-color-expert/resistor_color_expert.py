...
def resistor_label(colors: list[str]) -> str:
    ...
    value = (band1 * 100 + band2 * 10 + band3) * 10 ** zeros
    ohms, magn = 0, ''
    if value   > 1e9: ohms, magn = value / 1e9, 'giga'
    elif value > 1e6: ohms, magn = value / 1e6, 'mega'
    elif value > 1e3: ohms, magn = value / 1e3, 'kilo'
